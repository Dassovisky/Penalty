...
declare function GalleryRow({ products, summary, displayMode, itemsPerRow, lazyRender, rowIndex, listName, customSummaryInterval, CustomSummary, preferredSKU }: GalleryRowProps): JSX.Element;
