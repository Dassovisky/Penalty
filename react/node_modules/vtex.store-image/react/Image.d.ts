...
declare const CSS_HANDLES: readonly ["imageElement", "imageElementLink"];
export interface ImageProps extends ImageSchema, ImgHTMLAttributes<HTMLImageElement> {
...
declare namespace Image {
    ...
    var cssHandles: readonly ["imageElement", "imageElementLink"];
}
